...
NANP regexes build with data from https://simple.wikipedia.org/wiki/List_of_North_American_Numbering_Plan_area_codes
For NANP, there is no apparent mno identifier and Number Planning Area is
considered a part of subscriber number. Therefore, MnoID is empty and sn
contains NPA.
